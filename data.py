...
tours = {
    1: {
        ...
        "description": "Отель выглядит уютно. Он был построен из красного соснового дерева и украшен синими "
                       "камнями. Высокие округлые окна добавляют общий стиль дома и были добавлены в дом в "
    ...
    3: {
        ...
        "description": "Снаружи отель выглядит красиво и традиционно. Он был построен с белыми камнями и имеет "
                       "еловые деревянные украшения. Высокие, большие окна добавляют к общему стилю дома и были "
    ...
    4: {
        ...
        "description": "Каждый домик оборудован средней кухней и одной небольшой ванной комнатой, в нем также есть "
                       "уютная гостиная, две спальни, скромная столовая и большой подвал.  Небольшие треугольные "
                       "окна добавляют к общему стилю дома и были добавлены в дом в основном симметричным способом.",
        "departure": "msk",
    ...
    6: {
        ...
        "description": "Этот крошечный дом выглядит довольно современно и находится в ужасном состоянии. "
                       "Интерьер выполнен в цветах, которые напоминают вам о тропическом лесу. Двор небольшой и "
                       "заросший дикими растениями. Кроме того, это было однажды показано в телесериале, "
    ...
    7: {
        ...
        "description": "Этот дом средних размеров выглядит немного старомодно и находится в среднем состоянии. "
                       "Интерьер выполнен в цветах, которые напоминают о весеннем цветнике. Двор среднего размера "
                       "и напоминает луг. Кроме того, он был построен над остатками дома, который был разрушен "
                       "в результате пожара.",
        "departure": "ekb",
    ...
    8: {
        ...
        "description": "Этот огромный дом почти выглядит инопланетянином и находится в среднем состоянии. "
                       "Интерьер выполнен в цветах, напоминающих апельсиновое дерево. Двор среднего размера и "
                       "напоминает луг. Кроме того, это место печально известного убийства.",
        "departure": "kazan",
    ...
    9: {
        ...
        "description": "Этот большой дом имеет сказочный вид и находится в отличном состоянии. Интерьер "
                       "выполнен в ярких цветах. Двор маленький и аккуратно подстрижен. На заднем дворе есть большой "
                       "участок недавно созданной земли, а дом имеет большой решетчатый забор через него. "
                       "На заднем дворе живут различные животные. Многие владельцы приложили согласованные "
    ...
    11: {
        ...
        "description": "В доме очень хороший двор с большими камнями, похожими на озеро. В задней части "
                       "дома окна просторные, с большими окнами, они светлее, чтобы улучшить впечатление. Снаружи "
                       "есть пять маленьких деревьев. Двор в очень хорошем состоянии и очень живописный. "
    ...
    12: {
        ...
        "description": "Дом оборудован огромной кухней и одной современной ванной комнатой, а также имеет "
                       "огромную гостиную, две спальни, небольшую столовую, гостиную и скромную кладовую.  "
                       "Дом чистый, хорошо построенный и в хорошем состоянии, но, к сожалению, кровати сгорели "
                       "в мае этого года и, к сожалению, все еще нуждаются в ремонте. Возможно, понадобится "
                       "целая команда, чтобы заменить старую медную топку.",
        "departure": "kazan",
    ...
    13: {
        ...
        "description": "Снаружи этот дом выглядит очень элегантно. Он был построен из коричневого кирпича и "
                       "имеет коричневые кирпичные украшения. Высокие, большие окна добавляют к общему стилю дома "
                       "и были добавлены к дому в довольно асимметричном образце. Крыша высокая и наклонена "
                       "в одну сторону и покрыта коричневой черепицей. Один большой дымоход высовывает центр крыши. "
    ...
    14: {
        ...
        "description": "Крыша высокая, треугольная, многослойная, покрыта пшеничной соломой. Две большие трубы "
                       "находятся по обе стороны от дома. Многие меньшие окна пропускают много света в комнаты "
                       "под крышей. Сам дом окружен асфальтированной землей, с местом для еды и отдыха "
                       "на открытом воздухе и различными горшечными растениями.",
        "departure": "kazan",
    ...
    15: {
        ...
        "description": "Здание имеет форму круга. Дом частично окружен деревянными нависающими панелями с двух сторон. "
                       "Второй этаж меньше первого, что позволило создать несколько балконов по бокам дома. "
    ...
    16: {
        "title": "History Hotel & Spa",
        "description": "Это высокое здание из старого кирпича. Крыша высокая, треугольная, многослойная, покрыта "
                       "пшеничной соломой. В тесной квадратной спальне установлена деревянная и стеклянная мебель. "
                       "Пол деревянный, а стены текстурированы и окрашены.Настенные и напольные светильники "
                       "обеспечивают свет. Комната оформлена в цветах, напоминающих облачное небо, "
                       "и в целом выглядит очень старомодно. Первое, что вы заметите, это тщеславие.",
        "departure": "spb",
